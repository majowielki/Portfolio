    ...
    >
      ...
      <div className="flex flex-col items-center bg-[#2d343f] rounded-[28px] border border-transparent shadow-[0_0_20px_rgb(var(--main-color))] p-10 min-h-[370px] max-w-[340px] mx-auto transition-all duration-500 hover:border-main hover:scale-[1.03] cursor-pointer">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          ...
          <span className="px-3 py-1 bg-main/10 text-main rounded-full text-sm">ASP.NET Core</span>
          <span className="px-3 py-1 bg-main/10 text-main rounded-full text-sm">Entity Framework Core</span>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center bg-[#2d343f] rounded-[28px] border border-transparent shadow-[0_0_20px_rgb(var(--main-color))] p-10 min-h-[370px] max-w-[340px] mx-auto transition-all duration-500 hover:border-main hover:scale-[1.03] cursor-pointer">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          ...
          <span className="px-3 py-1 bg-main/10 text-main rounded-full text-sm">Tailwind</span>
      ...
      <div className="flex flex-col items-center bg-[#2d343f] rounded-[28px] border border-transparent shadow-[0_0_20px_rgb(var(--main-color))] p-10 min-h-[370px] max-w-[340px] mx-auto transition-all duration-500 hover:border-main hover:scale-[1.03] cursor-pointer">
        ...
        <h3 className="text-[30px] font-bold mb-5 text-center">Tools</h3>
        <div className="flex flex-wrap gap-2 justify-center">
          <span className="px-3 py-1 bg-main/10 text-main rounded-full text-sm">Azure</span>
